...
public class MaterielController implements Initializable {
    ...
    private String username = "mohamedamine.riahi@esprit.tn";
    @FXML
    private String password = "191JMT3137";
...
// Etape 2 : Création de l'objet Message
            ...
            message.setFrom(new InternetAddress(" mohamedamine.riahi@esprit.tn"));
